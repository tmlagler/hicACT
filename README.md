...
Further details on the Cauchy combination test underlying the HiC-ACT method can be found in the papers by Liu et. al ([Cauchy Combination Test](https://doi.org/10.1080/01621459.2018.1554485), [ACAT](https://doi.org/10.1016/j.ajhg.2019.01.002)). Details on the HiC-ACT method can be found in our [AJHG paper](https://doi.org/10.1016/j.ajhg.2021.01.009).
